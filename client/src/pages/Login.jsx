      ...
      <form onSubmit={(e) => handleLogin(e)}>
        <div className="absolute p-10 text-center text-black transition-all duration-300 bg-white rounded-lg shadow-2xl w-[400px] top-[20px] left-1/2 lg:left-[70%] transform -translate-x-1/2 z-20">
          <div className="w-full overflow-hidden h-[160px]">
            <img src="/images/login/skater_john.jpg" alt="Skater" className="object-cover w-full h-full" />
          </div>
          <h2 className="mt-20 mb-10 font-bold text-[36px]">{isSignUp ? "회원가입" : "로그인"}</h2>
          {!isSignUp ? (
            <div className="flex flex-col items-center">
              ...
              <button
                type="submit"
                className="p-8 text-white transition-all duration-300 bg-[var(--color-blue)] rounded-md w-[320px] text-[20px] hover:bg-[var(--color-green)]"
              >
                로그인
              </button>
            </div>
