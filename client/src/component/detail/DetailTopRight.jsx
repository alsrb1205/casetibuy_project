...
export default function DetailTopRight() {
    return (
        <div className="sticky top-0 self-start  w-[533px]">
            <div className="flex flex-col gap-10">
                ...
                <div>
                    ...
                    <div className='flex flex-col items-center mb-40 bg-white rounded-[16px] py-16 px-32'>
                    ...
                    <div className='flex justify-between items-center px-20 py-16 bg-white rounded-[16px] mb-24'>
